...
<div className="newdashboard-header">
  ...
  >
    <i className="bi bi-gift" style={{ color: "#d4af37" }}></i>  Limited availability - Book now!
  </div>
</div>
...
<div className="stats-cards">
	...
	<defs>
		<mask id="ipTShip0">
			<g fill="none" stroke="#fff" stroke-linejoin="round" stroke-width="4">
				<path stroke-linecap="round" d="M6 20.377L24 14l18 6.377L36.667 34H11.333z" clip-rule="evenodd" />
				<path fill="#555555" d="M13 8h22l-.002 9.896L24 14l-11 3.896z" />
				<path stroke-linecap="round" d="M24 8V4m0 20v-8M10 40l3.5 4l3.5-4l3.5 4l3.5-4l3.5 4l3.5-4l3.5 4l3.5-4" />
			</g>
		</mask>
	</defs>
	<path fill="currentColor" d="M0 0h48v48H0z" mask="url(#ipTShip0)" />
</svg>
    </div>
    <div className="stat-info">
      <h3>Private</h3>
  ...
  <div className="stat-card">
    <div className="stat-icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="42.86" height="40" viewBox="0 0 1920 1792">
  ...
  <div className="offer-card">
    ...
    <div className="offer-content">
      ...
      <div className="offer-actions">
        ...
        <span className="newbtn newbtn-small newbtn-whatsapp">Book Now</span>
      </div>
    </div>
  </div>
</a>
  ...
  <div className="offer-card locked-offer">
    ...
    <div className="offer-content">
      ...
      <a href="https://wa.me/9779709007758?text=I%20want%20to%20book%20the%20Greek%20Island%20Getaway%20package" target="_blank" rel="noopener noreferrer" className="newbtn newbtn-small">
        ...
        <a href="https://wa.me/9779709007758?text=I%20want%20to%20book%20the%20Greek%20Island%20Getaway%20package" target="_blank" rel="noopener noreferrer" className="newbtn newbtn-small newbtn-whatsapp">
          Book Now
        </a>
      </div>
    </div>
...
<div className="booking-section">
  <div className="booking-header">
    ...
    <p>Our travel experts are ready to help you plan your perfect Greek vacation</p>
  </div>
  ...
  <div className="booking-options">
    ...
    <div className="booking-card">
     ...
     <a href="https://wa.me/9779709007758?text=I%20want%20to%20book%20the%20Greek%20Island%20Getaway%20package" target="_blank" rel="noopener noreferrer"
...
<div style={{ textAlign: "center", marginTop: 50 }}>
  ...
  <a href="https://wa.me/9779709007758?text=I%20want%20to%20book%20the%20Greek%20Island%20Getaway%20package" target="_blank" rel="noopener noreferrer" className="newbtn newbtn-cta">
  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
