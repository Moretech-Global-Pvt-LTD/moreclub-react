  ...
  return (
    <div>
      <div style={{ textAlign: "center", }}>
        ...
        Unlock exclusive treasures Each treasure offers a unique adventure waiting to be discovered.
        </p>
        </div>
        ...
        <section class="treasure-intro">
            ...
            <p>Unlock exclusive treasures with More Deals Club – win dream vacations, premium city deals in Stockholm, and up to 50% off as a member. Contact our treasure hunt team today!.</p>
            <a href="https://wa.me/9779709007758?text=I'm%20interested%20in%20the%20Greek%20Island%20Getaway" class="newbtn newbtn-small newbtn-whatsapp"><i class="fab fa-whatsapp"></i> 
            <svg
...
{/* 
    ...
    <div className="treasure-grid">
      {/* Greek Island Treasure (Unlocked) */}
      <div className="treasure-card" >
        ...
        <div className="treasure-content">
          ...
          <div className="treasure-meta">
            <span>
              <i className="bi bi-calendar"></i> 5-7 Days
            </span>
            <span>
              <i className="bi bi-geo-alt"></i> Skiathos, Greece
            </span>
          </div>
          <div className="treasure-price">
            Win a trip, valued at $3999
          </div>
          <div className="treasure-features">
            <div className="treasure-feature">
              <i className="bi bi-building"></i>
              <span>Luxury Villa Accommodation</span>
            </div>
            <div className="treasure-feature">
              <i className="bi bi-boat"></i>
              <span>Private Island Cruise</span>
            </div>
          </div>
  ...
  <div className="booking-header">
    ...
    <p>
      Follow these simple steps to enter our exclusive giveaway and you could be enjoying this luxury vacation for free!
    </p>
  </div>
  ...
  <div className="booking-options">
    ...
    <div className="booking-card">
      ...
      <p>Get the best deals on food, salons & other services from our partners</p>
    </div>
    ...
    <div className="booking-card">
      ...
      <p>
        You're now officially qualified to win a trip to one of our amazing destinations — As a member, you're in the treasure paradise
      </p>
    </div>
  </div>
...
<div className="section-title">
  ...
  <p>
    ...
    <a href="https://morefood.se" target="_blank" rel="noopener noreferrer">
      morefood.se
    </a>
  </p>
</div>
...
<div className="treasure-grid">
  <div className="treasure-card" >
    ...
    <div className="treasure-content">
      ...
      <div className="treasure-meta">
      <span><i className="bi bi-utensils"></i> 50+ Guests</span>
      <span><i className="bi bi-geo-alt"></i> Stockholm</span>
      </div>
      <div className="treasure-price">
      ...
      <div className="treasure-features">
        ...
        <div className="treasure-feature">
          <i className="bi bi-check"></i>
          <span className="text-dynamic-white">Professional service staff</span>
        </div>
      </div>
      <a
  ...
  <div className="treasure-card" >
    ...
    <div className="treasure-content">
      ...
      <div className="treasure-features">
        <div className="treasure-feature">
        <i className="bi bi-check"></i>
        <span className="text-dynamic-white">Professional consultation</span>
        </div>
        <div className="treasure-feature">
        <i className="bi bi-check"></i>
        <span className="text-dynamic-white">Premium Hair Treatment</span>
        </div>
      </div>
      <button className="newbtn newbtn-small" style={{ width: '100%' }}>
        Book Now
  ...
  <div className="treasure-card" >
    ...
    <div className="treasure-content">
      ...
      <div className="treasure-features">
        ...
        <div className="treasure-feature">
        <i className="bi bi-check"></i>
        <span className="text-dynamic-white">Access to relaxation areas</span>
        </div>
      </div>
      <button className="newbtn newbtn-small" style={{ width: '100%' }}>
        Book Now
      ...
      <div className="booking-section">
        <div className="booking-header">
          ...
          <p>
          Our Treasure hunt experts are standing by to help you plan the perfect getaway. Choose your preferred contact method below.
          </p>
        </div>
