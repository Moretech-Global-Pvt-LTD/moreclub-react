...
const LiscenceContent = () => {
  ...
  return (
    ...
    <div id="privacypolicy" className="container p-4">
      ...
      {data && data.map((priv, index) => (
        <div
          className={`row ${index % 2 === 0 ? 'flex-lg-row-reverse' : ''} align-items-center mb-4`}
          key={index}
        >
          ...
          {priv.image ? (
            <div className={`col-12 col-lg-4 d-flex justify-content-center ${index % 2 !== 0 ? 'justify-content-lg-end' : 'justify-content-lg-start'} mb-3 mb-lg-0`}>
              <img src={`${imageURL}${priv.image}`} alt={priv.title} className="img-fluid" style={{ width: "200px", height: "200px", objectFit:"cover" }} />
            </div>
          ) : null}
        </div>
      ))}
...
export default LiscenceContent;
