...
const Chart = ({refersData, pointsdata, billingsData}) => {
  ...
  console.log("chartdata", refersData,  pointsdata, billingsData)
...
// Extract the data for the specified labels
  const extractedBillingsData = rearrangedLabels.map(label => billingsData[label].points);
  ...
  return (
    <Col sm={12} md={6} className="my-4 " style={{minHeight:"7rem", Width:"100%"}} >
