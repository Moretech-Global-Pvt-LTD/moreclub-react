...
const BusinessRegisterCreate = () => {
    ...
    const [inputBusinessRegistration, setInputBusinessRegistration] = useState('');
                                ...
                                <div className="row align-items-center">
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Business Name</Form.Label>
                                            <Form.Control id="title" type="text" value={inputBusinessName} onChange={e => setInputBusinessName(e.target.value)} required />
                                        </Form.Group>
                                    </div>
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Business Address</Form.Label>
                                            <Form.Control id="title" type="text" value={inputBusinessAddress} onChange={e => setInputBusinessAddress(e.target.value)} required/>
                                        </Form.Group>
                                    </div>
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Business Email</Form.Label>
                                            <Form.Control id="title" type="email" value={inputBusinessEmail} onChange={e => setInputBusinessEmail(e.target.value)} required/>
                                        </Form.Group>
                                    </div>
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Business Phone</Form.Label>
                                            <Form.Control id="title" type="tel" value={inputBusinessPhone} onChange={e => setInputBusinessPhone(e.target.value)} required/>
                                        </Form.Group>
                                    </div>
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Business Registration</Form.Label>
                                            <Form.Control id="title" type="text" value={inputBusinessRegistration} onChange={e => setInputBusinessRegistration(e.target.value)} required/>
                                        </Form.Group>
                                    </div>
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                    ...
                                    <div className="col-8">
                                        <div className="name-info d-flex align-items-center">
                                            ...
                                            <div className="name-author">
                                                <Link className="name d-block hover-primary text-truncate fz-20" to="#">
                                                    {inputBusinessName}
                                                </Link>
                                                ...
                                                <Link className="author d-block fz-12 hover-primary text-truncate" to="#">
                                                    <i className='bi bi-envelope-fill'></i> {inputBusinessEmail}
                                                </Link>
                                                <Link className="author d-block fz-12 hover-primary text-truncate" to="#">
                                                    <i className='bi bi-telephone-fill'></i> {inputBusinessPhone}
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
