...
import BussinessLogoUpdate from "../../pages/Businesspages/BusinessUpdate/BusinessLogoUpdate";
import BussinessCardaccounts from "../../pages/Businesspages/BusinessUpdate/BusinessCardUpdate";
    ...
    <div className="featured-nfts-wrap">
      <div className="container">
        <div className="row">
          <div className="tabs">
            <button
              className={`${activeTab === "Business-Details" ? "tablinks active" : "tablinks"} rounded-pills`}
            ...
            <button
              className={activeTab === "Business-Documents" ? "tablinks active" : "tablinks"}
              onClick={() => openTab("Business-Documents")}
            >
              Business Documents
            </button>
            <button
              className={activeTab === "Business-Cards" ? "tablinks active" : "tablinks"}
          ...
          <div className="nft-card">
            ...
            <div
              id="Business-Details"
              className={`
                ${activeTab === "Business-Details" ? "tabcontent active" : "tabcontent"} `
              }
            >
            ...
            <div
              ...
              className={
                activeTab === "Business-Documents" ? "tabcontent active" : "tabcontent"
              }
            >
            {business.businessProfile && 
            ...
            <div
              id="Business-Cards"
              className={
                activeTab === "Business-Cards" ? "tabcontent active" : "tabcontent"
              }
            >
            {business.businessProfile && 
              <PaymentForm/>
