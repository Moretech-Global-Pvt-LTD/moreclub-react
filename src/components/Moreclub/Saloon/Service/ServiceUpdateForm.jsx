...
// const ServiceVariationCreationForm = ({ ser_id, sal_id, data, onFinish, onCancel }) => {
...
//     const handleServerRemoveImage = async (id) => {
        
//         try {
//             const res = await axiosInstance.delete(`${moresaloonURL}/service-image/${id}`);
//             if (res.status === 200) {
//                 message.success("Image removed successfully");
//                 // queryClient.invalidateQueries(["saloon-service-variation", ser_id]);
//             }
//         }catch(err){
...
//             duration: serviceVariation.duration,
//         }
//         setLoading(false);
...
//                                         className="my-2"
//                                     />
//                                     <Button variant="danger" size="sm" onClick={() => handleServerRemoveImage(img.id)}>
//                                         &times;
//                                     </Button>
//                                 </div>
//                             ))}
