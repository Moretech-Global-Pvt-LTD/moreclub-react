...
//                 console.log("Group Chat Websoket Connected");
              
//             };

//             client.onmessage = function (event) {
//                 console.log("getting websocket message");
...
const WebsocketTest = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            wsRef.current = new ReconnectingWebSocket('ws://192.168.1.96:8000/ws/ride/');
